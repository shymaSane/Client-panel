  ...
  return (
    <div className="container mt-5 text-center"> 
        <div className="jumbotron">
            ...
            <Link className="btn btn-danger btn-lg mr-2" to="/users/signin" role="button">Sign In</Link>
            <Link className="btn btn-danger btn-lg" to="/users/signup" role="button">Sign Up</Link>
        </div>
    </div>
  )
}
